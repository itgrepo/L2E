with open('backendold/Astro_backend/app/ServiceConfig/organization_service.py', 'r') as f:
    content = f.read()

new_code = """from ServiceConfig import app, mysql, toJson, platform_decode, safe_json_loads, checkUserIsAdmin
...
def deleteOrganization():
    try:
        ...
        return jsonify({"status": "Error: " + str(e)})
"""
with open('backendold/Astro_backend/app/ServiceConfig/organization_service.py', 'w') as f:
    f.write(new_code)
