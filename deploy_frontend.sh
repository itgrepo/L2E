...
rsync -avz --exclude 'node_modules' --exclude '.git' -e "ssh -i ubuntuL2E.key -o StrictHostKeyChecking=no" ./frontend/src/components/AppSidebar.vue ubuntu@134.185.172.127:~/intelligist_dataX/frontend/src/components/AppSidebar.vue
