...
script_marker = "const showMouModal = ref(false);"
insertion = """
...
# 2. Add API fetch
fetch_marker = "dictionary: found.dictionary || [],"
fetch_insertion = """
        ...
        // merge them back just to keep rest of code happy
        selectedDataset.value = {
          ...selectedDataset.value,
"""
content = content.replace("dictionary: found.dictionary || [],", fetch_insertion)
